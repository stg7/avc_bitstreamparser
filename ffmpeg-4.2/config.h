...
#define FFMPEG_CONFIGURATION "--pkg-config-flags=--static --disable-doc --enable-pthreads --enable-debug=2 --disable-nvenc --disable-libx264 --enable-decoder=h264 --enable-parser=h264 --enable-demuxer=h264 --disable-vaapi"
